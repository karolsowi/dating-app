...
exports.getUsers = (req, res) => {
    ...
    try {
        ...
        console.log(`User ${currentUserId} has swiped on ${swipedUserIds.size} users`);
        ...
        const preferences = currentUser.partnerGender && Array.isArray(currentUser.partnerGender) 
